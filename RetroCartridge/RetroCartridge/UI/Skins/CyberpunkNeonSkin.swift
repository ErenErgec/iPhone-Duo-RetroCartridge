...
extension SkinTheme {
    static let cyberpunkNeon = SkinTheme(
        bodyColor: Color(red: 13/255, green: 13/255, blue: 13/255), // #0D0D0D
        buttonColor: Color(red: 26/255, green: 26/255, blue: 46/255), // #1A1A2E
